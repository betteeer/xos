...
@Data
public class PoInvoiceHeaderFormDTO {
    ...
    @Pattern(regexp = "^invoiceNumber|postingDate|netAmount|grossAmount$", message = "order by should within invoiceNumber,postingDate,netAmount,grossAmount")
