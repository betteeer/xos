...
//        url += HttpParamsUtils.getBodyParams(paramsMap);
        HttpUrl.Builder urlBuilder = HttpUrl.parse("http://system-preferences-service:3030/api/v1/coa-rel").newBuilder();
        urlBuilder.addQueryParameter("company_id", "71");
        urlBuilder.addQueryParameter("company_code", "3002");
