...
//                        }
    ...
    @Transactional
    public QueryUnReversedResVo getUnReversedByDocNumber(String docNumber, String companyCode, Integer onlyReversed) {
        ...
        if (onlyReversed.intValue() == 1) {
            materialDocLambdaQueryWrapper.eq(MaterialDoc::getIsReversed, ModuleConstant.IS_REVERSED.REVERSED);
        } else {
